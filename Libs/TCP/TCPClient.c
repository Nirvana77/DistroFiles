...
int TCPClient_Read(void* _Context, unsigned char* _Buffer, int _Size, TCPSocket_Error* _Error)
{
	TCPClient* _TCPClient = (TCPClient*) _Context;
	if(_TCPClient->m_Socket == NULL)
		return -1;

	return TCPSocket_Read(_TCPClient->m_Socket, _Buffer, _Size, _Error);
}

int TCPClient_Write(void* _Context, unsigned char* _Buffer, int _Size, TCPSocket_Error* _Error)
{
	TCPClient* _TCPClient = (TCPClient*) _Context;
	...
	return TCPSocket_Write(_TCPClient->m_Socket, _Buffer, _Size, _Error);
}
