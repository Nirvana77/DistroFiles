...
int TCPClient_Read(void* _TCPClient, unsigned char* _Buffer, int _Size, TCPSocket_Error* _Error);

int TCPClient_Write(void* _TCPClient, unsigned char* _Buffer, int _Size, TCPSocket_Error* _Error);
